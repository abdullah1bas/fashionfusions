  ...
  return (
    <Container className="my-5 flex justify-between">
      ...
      (<Search sx={{ display: "flex", borderRadius: "22px", justifyContent: "space-between",}}>
          ...
          <StyledInputBase className="ps-2" placeholder={t("Search…")} inputProps={{ "aria-label": "search" }} value={searchProduct}
            sx={{ flexGrow: 1 , pl: '5px !important' , '.css-1jrstcx-MuiInputBase-input': {pl: '10px !important'}}} onChange={e => setSearchProduct(e.target.value)}/>
